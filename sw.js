...
const PRECACHE_URLS = [
  '/mypetshop/',
  '/mypetshop/index.html',
  '/mypetshop/manifest.json',
  '/mypetshop/images/dog.png',
  '/mypetshop/images/cat.png',
  '/mypetshop/images/curler-hamster-icon.png'
];
    ...
    caches.match(event.request).then(cached => {
      ...
      return fetch(event.request).then(response => {
        ...
        if (event.request.mode === 'navigate') {
          return caches.match('/mypetshop/index.html');
        }
      });
    })
  );
